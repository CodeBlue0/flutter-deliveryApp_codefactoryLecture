...
final restaurantProvider =
    StateNotifierProvider<RestaruantStateNotifier, CursorPaginationBase>((ref) {
  final repository = ref.watch(RestaurantRepositoryProvider);

  final notifier = RestaruantStateNotifier(repository: repository);

  return notifier;
});

class RestaruantStateNotifier extends StateNotifier<CursorPaginationBase> {
  final RestaurantRepository repository;

  RestaruantStateNotifier({
